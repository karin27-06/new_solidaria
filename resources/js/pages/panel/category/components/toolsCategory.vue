<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Importar Excel -->
         <div>
            <input type="file" ref="fileRef" accept=".xlsx,.xls,.csv" class="hidden" @change="handleFileChange"/>
...
const handleFileChange = async (event: Event) => {
    ...
    toast({
        ...
        description: 'Las categorias fueron importadas correctamente.',
    })
    ...
    target.value = ''
        ...
        description: 'Revisa que el archivo sea válido (.xlsx, .xls o .csv) y vuelve a intentarlo.',
    })
    console.error(error)
  }
}
