<template>
    <div class="flex flex-wrap items-center gap-3 p-2">
        ...
        <!-- Exportar Excel -->
        <a href="/panel/reports/export-excel-products" download>
        ...
        <!-- Exportar PDF -->
         <a href="/panel/reports/export-pdf-products" download>
...
const handleFileChange = async (event: Event) => {
    ...
    try {
        await axios.post('/panel/reports/import-excel-products', formData, {
            headers: {
    ...
    toast({
        ...
        description: 'Los productos fueron importados correctamente.',
    })
