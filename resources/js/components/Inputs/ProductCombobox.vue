<template>
    ...
    <div v-else class="relative w-full">
        ...
        <div class="relative">
            ...
            <svg v-if="isSearching" class="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 animate-spin text-blue-600" viewBox="0 0 24 24">
        ...
        >
            ...
            <!-- Loading state -->
            <div v-if="isSearching" class="px-4 py-3 text-center text-sm text-gray-500">
            ...
            <!-- No results -->
            <div v-else-if="!validProducts.length && hasSearched && !isSearching" class="px-4 py-3 text-center text-sm text-gray-500">
                No products found for "{{ modelValue }}"
            </div>

            <!-- Instructions -->
            <div v-else-if="!hasSearched && modelValue.length < 3" class="px-4 py-3 text-center text-sm text-gray-500">
...
const validProducts = computed(() => {
    return products.value.filter(
        (product): product is ProductResource =>
            product !== null &&
